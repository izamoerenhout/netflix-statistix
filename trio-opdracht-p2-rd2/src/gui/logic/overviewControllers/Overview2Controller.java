...
public class Overview2Controller implements Initializable {
    ...
    /** Calls getAllAccountEmails from Overview2DAO and populates the ComboBox with all accountemzails from the database. */
    ...
    public void populateTableView() {
        ...
        try {
            ...
            tableOverview2.setItems(overview2DAO.getAllRecords(comboBoxSeries.getSelectionModel().getSelectedItem(), comboBoxAccounts.getSelectionModel().getSelectedItem()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
